package com.yt.gittest.common.dao.interceptor;
/**
 * 此拦截器可实现数据列表的排序及物理分页
 ...
 * <br>Version 1.0
 */
import com.yt.gittest.common.dao.Page;
...
public class PaginationInterceptor implements Interceptor {
    ...
    private static final org.apache.ibatis.reflection.ReflectorFactory reflectorFactory = new DefaultReflectorFactory();
